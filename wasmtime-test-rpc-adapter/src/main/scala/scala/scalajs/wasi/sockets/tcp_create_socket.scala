...
package object tcp_create_socket {
  ...
  /** Create a new TCP socket.
    ...
    * `bind`/`connect` is called, the socket is effectively an in-memory configuration object,
  ...
  @scala.scalajs.wit.annotation.WitImport(
    scala.scalajs.wit.annotation.WitScope("wasi", "sockets", "tcp-create-socket", "0.2.12"),
    "create-tcp-socket"
  )
  def createTcpSocket(
      @scala.scalajs.wit.annotation.WitName("address-family") addressFamily: IpAddressFamily
  ): scala.scalajs.wit.Result[TcpSocket, ErrorCode] = scala.scalajs.wit.native
