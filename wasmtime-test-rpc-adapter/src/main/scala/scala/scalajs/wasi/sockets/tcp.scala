...
package object tcp {
  ...
  type Duration = scala.scalajs.wasi.clocks.monotonic_clock.Duration
  ...
  @scala.scalajs.wit.annotation.WitEnum(
    scala.scalajs.wit.annotation.WitScope("wasi", "sockets", "tcp", "0.2.12"),
    "shutdown-type"
  )
  sealed trait ShutdownType
  object ShutdownType {
    @scala.scalajs.wit.annotation.WitName("receive")
    object Receive extends ShutdownType {
      override def toString(): String = "Receive"
    }
    @scala.scalajs.wit.annotation.WitName("send")
    object Send extends ShutdownType {
      override def toString(): String = "Send"
    }
    @scala.scalajs.wit.annotation.WitName("both")
  ...
  /** A TCP socket resource.
    ...
    *   - `connected`
    *   - `closed` See
    *     <https://github.com/WebAssembly/WASI/blob/main/proposals/sockets/TcpSocketOperationalSemantics.md>
    ...
    *
    * In addition to the general error codes documented on the `network::error-code` type, TCP
    * socket methods may always return `error(invalid-state)` when in the `closed` state.
    */
  ...
  final class TcpSocket private () extends Object {
    ...
    /** Bind the socket to a specific network on the provided IP address and port.
      ...
      * implementation to decide which network interface(s) to bind to. If the TCP/UDP port is zero,
      * the socket will be bound to a random free port.
      *
      ...
      *   - `address-not-bindable`: `local-address` is not an address that the `network` can bind
      *     to. (EADDRNOTAVAIL)
      *   - `not-in-progress`: A `bind` operation is not in progress.
      *   - `would-block`: Can't finish the operation, it is still in progress. (EWOULDBLOCK,
      *     EAGAIN)
      *
      * # Implementors note When binding to a non-zero port, this bind operation shouldn't be
      * affected by the TIME_WAIT state of a recently closed socket on the same local address. In
      * practice this means that the SO_REUSEADDR socket option should be set implicitly on all
      * platforms, except on Windows where this is the default behavior and SO_REUSEADDR performs
    ...
    def startBind(
        @scala.scalajs.wit.annotation.WitName("network") network: scala.scalajs.wit.Borrow[Network],
        @scala.scalajs.wit.annotation.WitName("local-address") localAddress: IpSocketAddress
    ...
    def finishBind(): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    ...
    /** Connect to a remote endpoint.
      ...
      *   - `invalid-argument`: `remote-address` is an IPv4-mapped IPv6 address. (EINVAL,
      *     EADDRNOTAVAIL on Illumos)
      ...
      *     EAGAIN)
      *
      * # Implementors note The POSIX equivalent of `start-connect` is the regular `connect`
      * syscall. Because all WASI sockets are non-blocking this is expected to return EINPROGRESS,
      * which should be translated to `ok()` in WASI.
      *
    ...
    def startConnect(
        @scala.scalajs.wit.annotation.WitName("network") network: scala.scalajs.wit.Borrow[Network],
        @scala.scalajs.wit.annotation.WitName("remote-address") remoteAddress: IpSocketAddress
    ): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    @scala.scalajs.wit.annotation.WitResourceMethod("finish-connect")
    def finishConnect()
        : scala.scalajs.wit.Result[scala.scalajs.wit.Tuple2[InputStream, OutputStream], ErrorCode] =
    ...
    /** Start listening for new connections.
      ...
      *   - `invalid-state`: The socket is already in the `connected` state. (EISCONN, EINVAL on
      *     BSD)
      ...
      *     EAGAIN)
      *
      * # Implementors note Unlike in POSIX, in WASI the listen operation is async. This enables
      * interactive WASI hosts to inject permission prompts. Runtimes that don't want to make use of
      * this ability can simply call the native `listen` as part of either `start-listen` or
      * `finish-listen`.
      *
      * # References
    ...
    def startListen(): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    @scala.scalajs.wit.annotation.WitResourceMethod("finish-listen")
    def finishListen(): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    ...
    /** Accept a new client socket.
      ...
      *   - `connection-aborted`: An incoming connection was pending, but was terminated by the
      *     client before this listener could accept it. (ECONNABORTED)
      *   - `new-socket-limit`: The new socket resource could not be created because of a system
      *     limit. (EMFILE, ENFILE)
      *
      * # References
    ...
    /** Get the bound local address.
      *
      * POSIX mentions: > If the socket has not been bound to a local name, the value > stored in
    ...
    def localAddress(): scala.scalajs.wit.Result[IpSocketAddress, ErrorCode] =
      scala.scalajs.wit.native
    ...
    def remoteAddress(): scala.scalajs.wit.Result[IpSocketAddress, ErrorCode] =
      scala.scalajs.wit.native
    ...
    def addressFamily(): IpAddressFamily = scala.scalajs.wit.native
    ...
    def setListenBacklogSize(
        @scala.scalajs.wit.annotation.WitName("value") value: scala.scalajs.wit.unsigned.ULong
    ): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    ...
    /** Enables or disables keepalive.
      ...
      *   - `keep-alive-idle-time`
      *   - `keep-alive-interval`
      *   - `keep-alive-count` These properties can be configured while `keep-alive-enabled` is
    ...
    def keepAliveEnabled(): scala.scalajs.wit.Result[Boolean, ErrorCode] = scala.scalajs.wit.native
    @scala.scalajs.wit.annotation.WitResourceMethod("set-keep-alive-enabled")
    def setKeepAliveEnabled(
        @scala.scalajs.wit.annotation.WitName("value") value: Boolean
    ): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    ...
    def keepAliveIdleTime(): scala.scalajs.wit.Result[Duration, ErrorCode] =
      scala.scalajs.wit.native
    @scala.scalajs.wit.annotation.WitResourceMethod("set-keep-alive-idle-time")
    def setKeepAliveIdleTime(
        @scala.scalajs.wit.annotation.WitName("value") value: Duration
    ): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    ...
    def keepAliveInterval(): scala.scalajs.wit.Result[Duration, ErrorCode] =
      scala.scalajs.wit.native
    ...
    def keepAliveCount(): scala.scalajs.wit.Result[scala.scalajs.wit.unsigned.UInt, ErrorCode] =
      scala.scalajs.wit.native
    @scala.scalajs.wit.annotation.WitResourceMethod("set-keep-alive-count")
    def setKeepAliveCount(
        @scala.scalajs.wit.annotation.WitName("value") value: scala.scalajs.wit.unsigned.UInt
    ): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    ...
    def hopLimit(): scala.scalajs.wit.Result[scala.scalajs.wit.unsigned.UByte, ErrorCode] =
      scala.scalajs.wit.native
    @scala.scalajs.wit.annotation.WitResourceMethod("set-hop-limit")
    def setHopLimit(
        @scala.scalajs.wit.annotation.WitName("value") value: scala.scalajs.wit.unsigned.UByte
    ): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
    ...
    def receiveBufferSize(): scala.scalajs.wit.Result[scala.scalajs.wit.unsigned.ULong, ErrorCode] =
      scala.scalajs.wit.native
    ...
    def sendBufferSize(): scala.scalajs.wit.Result[scala.scalajs.wit.unsigned.ULong, ErrorCode] =
      scala.scalajs.wit.native
    ...
    /** Create a `pollable` which can be used to poll for, or block on, completion of any of the
      ...
      *
      * The pollable is not limited to the async operation that happens to be in progress at the
      * time of calling `subscribe` (if any). Theoretically, `subscribe` only has to be called once
      * per socket and can then be (re)used for the remainder of the socket's lifetime.
      *
      * See
      * <https://github.com/WebAssembly/WASI/blob/main/proposals/sockets/TcpSocketOperationalSemantics.md#pollable-readiness>
      * for more information.
      *
    ...
    def shutdown(
        @scala.scalajs.wit.annotation.WitName("shutdown-type") shutdownType: ShutdownType
    ): scala.scalajs.wit.Result[Unit, ErrorCode] = scala.scalajs.wit.native
