...
package object error {
  ...
  /** A resource which represents some error information.
    ...
    * using the function `wasi:filesystem/types.filesystem-error-code`, which takes a
    * `borrow<error>` parameter and returns an `option<wasi:filesystem/types.error-code>`.
    *
  ...
  @scala.scalajs.wit.annotation.WitResourceImport(
    scala.scalajs.wit.annotation.WitScope("wasi", "io", "error", "0.2.12"),
    "error"
  )
