...
package object environment {
  ...
  @scala.scalajs.wit.annotation.WitImport(
    scala.scalajs.wit.annotation.WitScope("wasi", "cli", "environment", "0.2.12"),
    "get-environment"
  )
  ...
  /** Return a path that programs should use as their initial current working directory,
    * interpreting `.` as shorthand for this.
    */
  @scala.scalajs.wit.annotation.WitImport(
    scala.scalajs.wit.annotation.WitScope("wasi", "cli", "environment", "0.2.12"),
    "initial-cwd"
  )
  def initialCwd(): scala.scalajs.wit.Option[String] = scala.scalajs.wit.native
